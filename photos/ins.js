      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            var minSrc =
              "https://cdn.jsdelivr.net/gh/getlxc/getlxc.github.io@photo/min_photos/" +
              data.link[i];
            var src =
              "https://cdn.jsdelivr.net/gh/getlxc/getlxc.github.io@photo/photos/" +
              data.link[i];
            ...
            console.log(minSrc);
            liTmpl +=
              '<figure class="thumb" itemprop="associatedMedia" itemscope itemtype>\
                <a href="' +
              src +
              ...
              '" src="/photos/ ' +
              minSrc +
              '" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
        ...
        document.querySelector(".instagram").innerHTML =
          '<div class="photos" itemscope itemtype>' + ulTmpl + "</div>";
        createVideoIncon();
        _view2.default.init();
      };
